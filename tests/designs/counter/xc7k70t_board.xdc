...
set_property PACKAGE_PIN F8 [get_ports io_led[4]]
set_property PACKAGE_PIN C8 [get_ports io_led[5]]
set_property PACKAGE_PIN A8 [get_ports io_led[6]]
set_property PACKAGE_PIN D9 [get_ports io_led[7]]
